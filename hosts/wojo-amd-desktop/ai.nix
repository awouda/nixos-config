...

{
  ...
  services.ollama = {
    ...
    environmentVariables = {
      ...
      # The "Golden Ratio": 28.5 GiB in bytes
      # This keeps 32B models in VRAM but saves a couple of GB for "Compute Buffers"
      # 28,5 GiB = 28.5 * 1024 * 1024 * 1024
      OLLAMA_VRAM_OVERRIDE = "30601641984";
